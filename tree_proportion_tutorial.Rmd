...
We take the best model determined by IQ-Tree to supply the function parameter `best_model = "JC"`, and the file path to the tree inferred by IQ-Tree as the parameter `treefile = paste0(repo_path, "tutorial/alignment1.fasta.treefile")`
```{r}
...
**4.b.** Applying the parametric bootstrap to alignment 2
We take the best model determined by IQ-Tree to supply the function parameter `best_model = "JC"`, and the file path to the tree inferred by IQ-Tree as the parameter `treefile = paste0(repo_path, "tutorial/alignment2.fasta.treefile")`
```{r}
# Create a new directory for outputting parametric bootstrap replicates
